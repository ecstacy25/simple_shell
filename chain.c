...
/**
 * is_chain - this tests if current char in buffer is a chain
 * delimeter
 * @info: this represents the parameter struct
 * @buf: represents the char buffer
...
/**
 * replace_alias - this replaces the aliases in the tokenized string

...
/**
 * input_buf - represents buffers chained commands
...
ssize_t get_input(info_t *info)
{
	...
	if (len)	/* here, we have commands left in the chain buffer */
	{
		...
		p = buf + i; /* this gets pointer for return */
		...
		*buf_p = p; /* here, pass back pointer to current command position */
 ...
 * @length: represents the size of preallocated ptr buffer if not NULL
 *
 * Return: s
 */

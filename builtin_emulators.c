...
/**
 * _mycd - this changes the working directory of the process
 * @info: this represents the Structure containing potential arguments.
 * It is Used to maintain constant function prototype.
 * Return: Always 0
 */
int _mycd(info_t *info)
{
	...
	if (!info->argv[1])
	{
		...
		if (!dir)
			chdir_ret = /* TODO: How should this be? */
...
/**
 * _myhelp - this changes the working directory of the process
 * @info: this represents the Structure containing potential arguments.
 * It is Used to maintain constant function prototype.
...
int _myhelp(info_t *info)
{
	...
	arg_array = info->argv;
	_puts("helps to call works. Function is  not yet implemented \n");
	if (0)
